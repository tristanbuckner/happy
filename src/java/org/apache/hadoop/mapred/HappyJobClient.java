 ...
 */
public class HappyJobClient extends Configured implements MRConstants, Tool  {
  private static final Log LOG = LogFactory.getLog(HappyJobClient.class);
   ...
   * @throws IOException
   */
  public HappyJobClient(JobConf conf) throws IOException {
    setConf(conf);
    init(conf);
  }
   ...
   */
  public HappyJobClient(InetSocketAddress jobTrackAddr,
                   Configuration conf) throws IOException {
...
//    }
    ...
    Configuration commandConf = HappyJobClient.getCommandLineConfig();
    String files = null;
    String libjars = null;
  ...
  throws IOException {
    ...
    static class JobKiller extends Thread{
        private RunningJob runningJob;

        JobKiller(RunningJob runningJob) {
        ...
        {
            try {
                if(!runningJob.isComplete()) runningJob.killJob();
            } catch (Exception e) {
            }
        }
    }
  ...
  public static RunningJob runJob(JobConf job) throws IOException {
    HappyJobClient jc = new HappyJobClient(job);
    boolean error = true;
    ...
    try {
      ...
      JobKiller jobKiller = null;
    try {
      running = jc.submitJob(job);
        jobKiller = new JobKiller(running);
...
*/
  ...
  public static void main(String argv[]) throws Exception {
    int res = ToolRunner.run(new HappyJobClient(), argv);
    System.exit(res);
  }
}
